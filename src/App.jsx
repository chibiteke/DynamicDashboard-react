...
export class App extends React.Component {
    constructor() {
        ...
        this.tileCatalog = [
            { name: 'グリッド', tile: Grid, icon: this.icons.grid },
            { name: '円形ゲージ', tile: RadialGauge, icon: this.icons.radialGauge },
            { name: '線形ゲージ', tile: LinearGauge, icon: this.icons.linearGauge },
            { name: '横棒グラフ', tile: BarChart, icon: this.icons.barChart },
            { name: '縦棒グラフ', tile: ColumnChart, icon: this.icons.columnChart },
            { name: '折れ線チャート', tile: LineChart, icon: this.icons.lineChart },
            { name: 'バブルチャート', tile: BubbleChart, icon: this.icons.bubbleChart },
            { name: 'ブレットグラフ', tile: BulletGraph, icon: this.icons.bulletGraph },
            { name: '空白', tile: Blank, icon: this.icons.blank },
        ];
        this.key = 0;
        this.state = {
            isWideMenu: false,
